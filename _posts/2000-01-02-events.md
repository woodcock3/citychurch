...
<ul class="map collapsible">
  ...
  <li>
    ...
    <div class="collapsible-body"><span style="color:events">Please park in the church carpark or on Elland Road. Do not park in front of driveways on Malvern Street.</span>
      <a class="map-apply waves-effect waves-light btn bg-white" href="https://goo.gl/maps/4kcnTLjt1V7ZkiCK6" target="blank">View larger map</a></div>
  </li>
  <li>
    <div class="collapsible-header">i class="fa fa-bus fa-4x"></i>Bus</div>
    <div class="collapsible-body"><span>Get off the number 10 bus between Headingley and Beeston at the traffic lights on Beeston Road. Then walk for 2 minutes down Cemetery Road to the church.</span></div>
  </li>
</ul>
